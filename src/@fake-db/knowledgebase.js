...
mock.onGet('/@fake-db/knowlwdgebase/category').reply(() => {
  const allArticles = []
...
mock.onGet('/@fake-db/knowledgebase/subcategory').reply(config => {
...
mock.onGet('/@fake-db/knowledgebase/article').reply(config => {
